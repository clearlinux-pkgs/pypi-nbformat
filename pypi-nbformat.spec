...
Source0  : https://files.pythonhosted.org/packages/eb/51/ad97f33007b51095f551fc06391f13d28a45f62c0c051837331970e01557/nbformat-5.3.0.tar.gz
...
%prep
%setup -q -n nbformat-5.3.0
cd %{_builddir}/nbformat-5.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649084326
...
cp %{_builddir}/nbformat-5.3.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-nbformat/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
