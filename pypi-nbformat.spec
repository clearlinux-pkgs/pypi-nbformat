...
Source0  : https://files.pythonhosted.org/packages/ad/c1/adfa72efcf08421a0bd6e3f9a14d6e0e2e52bf9ad7bd881d664f221708be/nbformat-5.10.3.tar.gz
...
%prep
%setup -q -n nbformat-5.10.3
cd %{_builddir}/nbformat-5.10.3
pushd ..
cp -a nbformat-5.10.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710540710
